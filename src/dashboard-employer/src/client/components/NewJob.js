        ...
        <div class="grid grid-cols-1 gap-6 mt-2">
            ...
            <div class = "grid grid-cols-2">
                <div class = :a>
                    ...
                    min = "15" max = "35" step = "0.25" value = "15" class="block w-full py-2 mt-2 accent-coral-red text-gray-700 bg-white border border-gray-300 rounded-md transition ease-in">
                ...
                <div>
                    ...
                    min = "1" max = "40" step = "1" value = "20" class="block w-full py-2 mt-2 accent-coral-red text-gray-700 bg-white border border-gray-300 rounded-md">
