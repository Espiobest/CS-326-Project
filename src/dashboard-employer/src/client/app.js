...
export class App {
    ...
    async render(root){
        ...
        this.#dashboardElem.classList.add("hidden", "grid", "grid-cols-2", "gap-4", "p-4");
        const dashboard = new Dashboard(); //create dashboard component
        dashboard.setJobs(await this.#jobs.loadAllJobs());
        this.#dashboardElem.appendChild(dashboard.render());
        //set curJob element
        const dashboardFunc = new DashboardFunc();
        this.#dashboardElem.appendChild(await dashboardFunc.render());
        ...
        this.#newJobElem.appendChild(await form.render());
        ...
        const deleteAllJobs = document.getElementById('delete-all');
            deleteAllJobs.addEventListener('click', async (event) => {
                ...
                this.#dashboardElem.appendChild(dashboard.render());
                document.getElementById('cur-jobs').remove();
        })
